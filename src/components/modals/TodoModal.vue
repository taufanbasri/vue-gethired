        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <h3 class="text-lg font-semibold" data-cy="modal-add-title">
                  Tambah Item List
                </h3>

                <div
                  class="w-6 h-6 cursor-pointer text-[#A4A4A4]"
                  @click="closeModal"
                >
              ...
              <div class="px-6 my-6">
                <div>
                  <label
                    ...
                    for="price"
                    class="block text-xs font-semibold text-dark"
